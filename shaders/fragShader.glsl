...
void main()
{
	...
	color = ambient_color + diffuse_color * u_light_color * light_power * cosTheta / (distance*distance) + specular_color * u_light_color * light_power * pow(cosAlpha, 2)  / (distance*distance);
